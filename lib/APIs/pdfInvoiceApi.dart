...
class PdfInvoiceApi {
  static Future<String> generateReport(
      Account account, String reportTitle, String period, List<my.Transaction> transactions) async {
    final pdf = Document();
    ...
    return PdfApi.saveReport(
        name: "REPORT_${DateTime.now().millisecondsSinceEpoch.toString()}.pdf",
        pdf: pdf,
        account: account); 
  }
    ...
    return Row(
      ...
      children: [
        Column(
          ...
          children: [
            Text("PAID AMOUNT ", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18.0)),
            Text("KES $paidTotal", style: TextStyle(fontWeight: FontWeight.bold)),
          ]
        ),
        Column(
          mainAxisSize: MainAxisSize.min,
          ...
          mainAxisAlignment: MainAxisAlignment.end,
          children: [
            Text("UNPAID AMOUNT ", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18.0)),
            Text("KES $unpaidTotal", style: TextStyle(fontWeight: FontWeight.bold)),
          ]
        ),
      ]
    );
