...
import 'package:rekodi/model/event.dart';
...
class _TodoCalendarState extends State<TodoCalendar> {
  ...
  List<Event> _getEventsForDay(DateTime day) {
    ...
    return kEvents[day] ?? [];//todo: fetch from firestore
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        TableCalendar<Event>(
          firstDay: DateTime.fromMillisecondsSinceEpoch(startDate),
          lastDay: DateTime.fromMillisecondsSinceEpoch(endDate),
