...
class _BulkSMSSectionState extends State<BulkSMSSection> {
  ...
  sendBulkSMS(Account currentUser) async {
    ...
    await FirebaseFirestore.instance
        ...
        .collection("bulkSMS")
        .doc(bulkSMS.timestamp.toString())
        .set(bulkSMS.toMap());
                          ...
                          if (!snapshot.hasData) {
                            ...
                            if (tenants.isEmpty) {
                              ...
                              return Column(
                                ...
                                children:
                                    List.generate(tenants.length, (index) {
                                      ...
                                      isSelected: (v) {
                                        setState(() {
                                          if (v) {
                                            ...
                                            selectedTenants.removeWhere((acc) =>
                                                tenant.userID == acc.userID);
                                          }
                                        });
                                      });
                                }),
                        ...
                        child: RaisedButton.icon(
                          onPressed: () {
                            if (selectedTenants.isNotEmpty &&
                                controller
                                    .text.isNotEmpty) //todo: && balance != 0)
                            {
                              sendBulkSMS(account);
                            } else {
                              Fluttertoast.showToast(
                                  msg: "Select Tenants and Type something");
                            }
                          },
                          ...
                          label: Text("Send To ${selectedTenants.length}",
