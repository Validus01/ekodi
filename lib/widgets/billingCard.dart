...
class _BillingCardState extends State<BillingCard> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ListTile(
                        ...
                        subtitle: const Text(
                            "Pay your electricity bills through our platform"),
                        trailing: isMobile
                            ? null
                            : const Text(
                                "KES 0.0 Spent",
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        subtitle:
                            const Text("Pay for rent using your bank card"),
                      ),
                      ListTile(
                        onTap: () {
  ...
  proceedToPayRent(Account sender, Unit unit, Size size) async {
    ...
    String transactionType = await showPaymentOptions(
      context,
    );
    ...
    if (transactionType == "M-Pesa") {
      if (kIsWeb) {
        response = await MPesaAPI().performTransactionWeb(
            sender,
            amountController.text.trim(),
            int.parse(phoneController.text.trim()));
      } else {
        response = await MPesaAPI().performTransactionMobile(
            sender, amountController.text.trim(), phoneController.text.trim());
      }
    }
    ...
    if (response == "success") {
      ...
      Invoice invoiceDetails = Invoice(
        ...
        receiverInfo: receiver!.toMap(),
        pdfUrl: '',
        isPaid: unit.rent! - int.parse(amountController.text.trim()) < 1
            ? true
            : false,
        bills: [
          Bill(
      ...
      final String pdfUrl =
          await PdfInvoiceApi.generateInvoice(sender, invoiceDetails);
      ...
      String res = await Transactions()
          .payRent(transaction, invoiceFinal, sender, receiver!, unit);
  ...
  showConfirmationRequest(
      BuildContext context, Account account, Unit unit, bool isMobile) {
    showDialog(
        context: context,
        barrierDismissible: true,
        builder: (c) {
          return AlertDialog(
            ...
            content: const Text(
                "Do you want to vacate the property? A request will be sent to your landlord."),
            actions: [
              RaisedButton.icon(
                onPressed: () {
                  Navigator.pop(context);
  ...
  Widget _buildForMobile(
      Account account, Size size, int startDate, int endDate, bool isPaying) {
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        "KES " +
                                                                            NumberFormat("###,###.0#", "en_US").format(units[0].rent),
                                                                        style: TextStyle(
                                                                            color:
                                                                                EKodi.themeColor,
                                                                            fontWeight: FontWeight.bold),
                                                                      ...
                                                                      Text(
                                                                        "Due on: " +
                                                                            DateFormat("dd MMM yyyy").format(DateTime.fromMillisecondsSinceEpoch(units[0].dueDate!)),
                                                                        style: const TextStyle(
                                                                            fontSize:
                                                                                12.0,
                                                                            fontWeight:
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        "KES " +
                                                                            NumberFormat("###,###.0#", "en_US").format(units[0].deposit),
                                                                        style: const TextStyle(
                                                                            color:
                                                                                Colors.orange,
                                                                            fontWeight: FontWeight.bold),
  ...
  performResponse(Account account, Size size, Property property, Unit unit,
      String choice) async {
    if (choice == "denied") {
      await FirebaseFirestore.instance
          .collection("users")
          ...
          return Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                    "You have been added to ${property.name}, unit ${unit.name}, rent payment of KES ${unit.rent} on ${unit.paymentFreq} basis and a deposit of KES ${unit.deposit}"),
              ),
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Expanded(
                    flex: 1,
                    child: TextButton(
                      onPressed: () => performResponse(
                          account, size, property, unit, "denied"),
                  ...
                  Expanded(
                    ...
                    child: RaisedButton(
                      onPressed: () => performResponse(
                          account, size, property, unit, "accepted"),
                      color: EKodi.themeColor,
                      child: const Text(
                        "Accept",
                        style: TextStyle(color: Colors.white),
                                                                    ...
                                                                    Text(
                                                                      "Started on: " +
                                                                          DateFormat("dd MMM yyyy")
                                                                              .format(DateTime.fromMillisecondsSinceEpoch(units[0].startDate!)),
                                                                      style: const TextStyle(
                                                                          fontSize:
                                                                              12.0,
                                                                          fontWeight:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Text(
                                                                                ...
                                                                                style: const TextStyle(color: EKodi.themeColor, fontWeight: FontWeight.bold),
                                                                              ),
                                                                              const SizedBox(
                                                                                height: 5.0,
                                                                              ),
