      ...
      for (Unit unit in selectedUnits) {
        if (selectedTenants.contains(unit.tenantInfo)) {
          ...
          Invoice invoiceDetails = Invoice(
            ...
            pdfUrl: '',
            isPaid:
                unit.rent! - int.parse(amount.text.trim()) < 1 ? true : false,
            bills: [
              Bill(
                timestamp: DateTime.now().millisecondsSinceEpoch,
                billType: "Rent",
                ...
                isPaid: unit.rent! - int.parse(amount.text.trim()) < 1
                    ? true
                    : false,
              ).toMap(),
            ],
          ...
          final String pdfUrl =
              await PdfInvoiceApi.generateInvoice(account, invoiceDetails);
          ...
          await Transactions()
              .payRent(transaction, invoiceFinal, tenant, account, unit);
        }
      }
                                  ...
                                  child: Container(
                                    ...
                                    child: const Padding(
                                      ...
                                      child: Center(
                                        ...
                                        "Back",
                                        style:
                                            TextStyle(color: EKodi.themeColor),
                                      )),
                                    ),
                                  ),
                                ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    onPressed: () =>
                                        displayCalendar(context, isMobile),
                                    icon: const Icon(
                                          ...
                                          children: [
                                            Icon(Icons.error_outline_rounded,
                                                color: EKodi.themeColor
                                                    .withOpacity(0.3)),
                                            const Text(
                                              "Ignore if invoice reference does not appear here.",
                                              maxLines: 2,
                                              style: TextStyle(
                                                fontSize: 12.0,
                                              ),
                                          ...
                                          children: List.generate(
                                            ...
                                            return Card(
                                              ...
                                              child: ListTile(
                                                ...
                                                subtitle: Text(
                                                  "Unpaid rent for ${invoice.senderInfo!["name"]}, Unit: ${invoice.unitInfo!["name"]}",
                                                  maxLines: 3,
                                                  overflow:
                                                      TextOverflow.ellipsis,
                                                ),
                                                trailing: Text("KES " +
                                                    invoice.unitInfo!["rent"]),
                                              ),
                                            );
                                          }),
                                        ),
                          ...
                          children: [
                            ...
                            StreamBuilder<QuerySnapshot>(
                              stream: FirebaseFirestore.instance
                                  ...
                                  .where("paymentCategory", isEqualTo: "Rent")
                                  .snapshots(),
                              builder: (context, snapshot) {
                                if (!snapshot.hasData) {
                                  ...
                                  for (var element in snapshot.data!.docs) {
                                    transactions.add(account_transaction
                                        .Transaction.fromDocument(element));

                                    rentTotal = rentTotal +
                                        account_transaction.Transaction
                                                .fromDocument(element)
                                            .paidAmount!;
                                  }
                                  ...
                                  if (transactions.isEmpty) {
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "Total Rent Collected: KES $rentTotal",
                                          style: const TextStyle(
                                              fontWeight: FontWeight.bold),
                                        ),
                                        const SizedBox(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              "Total Revenue: KES ${context.watch<AccountingProvider>().income - context.watch<AccountingProvider>().expense}",
                                              style: const TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  color: Colors.green),
                                            ),
