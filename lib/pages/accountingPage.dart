...
class _AccountingState extends State<Accounting> {
  ...
  proceedToAddExpense(Account account) async {
    ...
    account_transaction.Transaction transaction =
      ...
      remainingAmount: 0,
      properties: List.generate(selectedProperties.length,
          (index) => selectedProperties[index].propertyID),
      serviceProviders: [],
      tenants: [],
                          ...
                          isSelected: (v) {
                            setState(() {
                              if (v) {
                                ...
                                selectedProperties.removeWhere((property) =>
                                ...
                                if (transactions.isEmpty) {
                                  ...
                                  return Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "Total Expense: KES $expenseTotal",
                                        style: const TextStyle(
                                            fontWeight: FontWeight.bold),
                                      ),
                                      const SizedBox(
...
class PropertyItem extends StatefulWidget {
  ...
  const PropertyItem({Key? key, this.property, this.isSelected})
      : super(key: key);
