...
class OverdueRentPayments extends StatefulWidget {
  const OverdueRentPayments({Key? key}) : super(key: key);

  @override
  State<OverdueRentPayments> createState() => _OverdueRentPaymentsState();
}

class _OverdueRentPaymentsState extends State<OverdueRentPayments> {
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text("Overdue Rent Payments", style: Theme.of(context).textTheme.titleMedium,)
                  ],
                ),
