...
class _IncomeExpenseStatementState extends State<IncomeExpenseStatement> {
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text("Income Expense Statement", style: Theme.of(context).textTheme.titleMedium,)
              ],
            ),
  ...
  Widget _buildForMobile(BuildContext context, Size size,) {
    return loading ? const LoadingAnimation(): Padding(
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveBuilder(
      builder: (context, sizeInfo) {
        ...
        return isMobile ? _buildForMobile(context, size) : _buildForDesktop(context, size);
      },
    );
  }
}
...
class CustomDropDown extends StatelessWidget {
  ...
  const CustomDropDown({Key? key, this.title, this.items, this.selectedItems, this.onChanged, this.labelText, this.hintText, this.selectedItem, this.onMultiChanged, this.isMultiselect, this.itemAsString}) : super(key: key);
        ...
        children: [
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: isMultiselect! ? DropdownSearch<dynamic>.multiSelection(
                mode: Mode.MENU,
                items: items!,
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveBuilder(
      builder: (context, sizeInfo) {
        return sizeInfo.isMobile || sizeInfo.isTablet ? _buildForMobile(context, size) : _buildForDesktop(context, size);
