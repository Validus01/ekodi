    ...
    if(result != null)
      {
        ...
        for (var platformFile in result.files) {
          String url = await FileManager().uploadPropertyPhoto(property, platformFile);
    ...
    return loading ? const LoadingAnimation() : Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Text("Property Images", style: Theme.of(context).textTheme.titleMedium,),
            RaisedButton.icon(
                    ...
                    return Column(
                      ...
                      children: List.generate(imagesCollection.length, (index) {
                        return Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(DateFormat("dd MMM").format(DateTime.fromMillisecondsSinceEpoch(imagesCollection[index].timestamp!))),
                            const SizedBox(height: 10.0,),
                            GridView.count(
                              crossAxisCount: 2,
