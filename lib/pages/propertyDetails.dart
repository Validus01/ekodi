...
class _PropertyDetailsState extends State<PropertyDetails> {
  ...
  Widget showUnits(
      List<Unit> units, Size size, bool isMobile, Property property) {
    List<Widget> unitsWidgets = List.generate(units.length, (index) {
      Unit unit = units[index];
      String date = DateFormat('dd MMM yyyy')
          .format(DateTime.fromMillisecondsSinceEpoch(unit.startDate!));
          ...
          child: Column(
            ...
            children: [
              ...
              unit.isOccupied!
                  ? ListTile(
                      title: Text(
                        "Occupied By: ${unit.tenantInfo!["name"]}",
                        maxLines: 2,
                        overflow: TextOverflow.ellipsis,
                      ),
                      subtitle: Text("From $date to Date"),
                      trailing: Text(
                        "Rent: KES ${unit.rent.toString()}",
                        style: const TextStyle(fontWeight: FontWeight.bold),
                      ),
                    )
                  : Container()
  ...
  showAddExpense(BuildContext context, Account account, Size size,
      bool isMobile, Property property) {
    showDialog<void>(
      context: context,
  ...
  showAddUnits(
      BuildContext context, Account account, Size size, Property property) {
    showDialog(
        context: context,
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          SizedBox(
                            width:
                                isDesktop ? size.width * 0.2 : size.width * 0.6,
                            child: Column(
                              mainAxisSize: MainAxisSize.min,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(color: EKodi.themeColor, width: 1.0)),
                  child: const Padding(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                            "Once you add a tenant, you can start tracking your rent payments"),
                        const SizedBox(
                          height: 10.0,
                        ),
                        RaisedButton.icon(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () => showAddExpense(
                            context, account, size, false, property),
                        child: Container(
                          height: 25.0,
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(3.0),
                          ...
                          return Column(
                            ...
                            children:
                              ...
                              return ListTile(
                                ...
                                trailing: Text("Kes " +
                                    transactions[index].paidAmount.toString()),
                              );
                            }),
                          );
                        }
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () =>
                            showAddUnits(context, account, size, property),
                        child: Container(
                          height: 25.0,
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(3.0),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () => showAddExpense(
                                    context, account, size, true, property),
                                child: Container(
                                  height: 25.0,
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(3.0),
                          ...
                          FutureBuilder(
                            future: FirebaseFirestore.instance
                                ...
                                .collection("transactions")
                                .where("properties",
                                    arrayContains: property.propertyID)
                                .where("paymentCategory", isNotEqualTo: "Rent")
                                .get(),
                            builder: (context, snapshot) {
                              if (!snapshot.hasData) {
                                ...
                                List<account_transaction.Transaction>
                                    transactions = [];
